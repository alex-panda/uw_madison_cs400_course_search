...
public class TestBackEnd {
  ...
  public static boolean test1() {
    ...
    if (hashMap.size() != 0) {
      System.out
          .print("Failed: The hashMap size was supposed to be 0 but was " + hashMap.size() + "\n");
      return false;
    }
    ...
    if (hashMap.size() != 100) {
      System.out.print(
          "Failed: The hashMap size was supposed to be 100 but was " + hashMap.size() + "\n");
      return false;
    }
  ...
  public static boolean test3() {
    ...
    for (int i = 0; i < 1000; i++) {
      try {
        ...
        if (value == null || !value.equals("i: " + i)) {
          System.out.print("Failed: The hashmap did not return the correct value for " + "" + "Map"
              + i + ". Returned value: " + value + "\n");
          return false;
        }
    ...
    if (hashMap.size() != 1000) {
      System.out.print("Failed: The hashMap size was supposed to be 1000, " + "but was "
          + hashMap.size() + "\n");
      return false;
    }
