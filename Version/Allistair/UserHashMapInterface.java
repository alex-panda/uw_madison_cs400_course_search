...
/**
 * The Backend Developer 1 UserHashMapInterface to link frontend to individual hash maps
 * 
 * @author Ben
 *
 */
public class UserHashMapInterface {
  ...
  /**
   * Adds a course to the hash table. Returns false if does not add because element is already
   * present.
   * 
