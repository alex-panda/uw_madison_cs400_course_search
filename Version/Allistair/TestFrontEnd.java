...
public class TestFrontEnd {
  ...
  /**
   * Test that sets up the command line so that the tester can very easily look through and check
   * whether the classes are displayed correctly (must manually check because there are many ways to
   * display the data because of multiple frontends).
   */
  ...
  // Helper Classes
  /**
   * Helper method that reads data from the CS_course_info csv and returns an ArrayList of String
   * arrays containing what each comma-seperated section contained.
   *
